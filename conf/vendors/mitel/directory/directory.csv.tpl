...
{%- if info.description and info.user_name -%}
{%- set parts = info.description | split: " " -%}
{{ parts.0 }},{{ parts.1 | default: "" }},{{ domain.variables.company | default: "" }},{{ domain.variables.job_title | default: "" }},{{ domain.variables.work_street | default: "" }},{{ domain.variables.work_city | default: "" }},{{ domain.variables.work_state | default: "" }},{{ domain.variables.work_zip | default: "" }},{{ domain.variables.work_country | default: "" }},,,,,,{{domain.variables.email | default: "" }},,,1,1,1,{{ info.user_name }},,,,
{% endif -%}
{%- endfor -%}
{%- else -%}
